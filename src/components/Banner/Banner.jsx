        ...
        <div className='relative'>
            ...
            >
                <div className='bg-banner-one relative pt-[50px] pb-100 sm:py-[200px] overflow-hidden cursor-default'>
                    ...
                    <div className='absolute right-0 sm:right-[50px] bottom-0 sm:top-[200px] z-30 pointer-events-none select-none'>
                ...
                {/* <div className='bg-banner-one relative pt-[50px] pb-80 sm:py-[200px] overflow-hidden cursor-default'>
                    ...
                    <img src={banner_element_06} alt="banner_element_06" className='absolute right-[60px] bottom-[280px] z-30 pointer-events-none select-none' />
                    <img src={banner_element_07} alt="banner_element_07" className='absolute left-[650px] bottom-0 z-30 pointer-events-none select-none' />
                    <img src={banner_img_bg_02} alt="banner_img_bg_02" className='absolute sm:right-[150px] sm:top-[50px] w-[350px] sm:w-[700px] bottom-5 pointer-events-none select-none' />
                    <img src={banner_img_02} alt="banner_img_bg_02" className='absolute sm:right-[100px] sm:top-[110px] bottom-5 pointer-events-none select-none' />
                    <Container>
                        <div className='flex'>
                            <div>
                                <div className='flex items-center gap-3 justify-center sm:justify-start mt-10'>
                ...
                {/* <div className='bg-banner-one relative pt-[50px] pb-80 sm:py-[200px] overflow-hidden cursor-default'>
                    ...
                    <img src={banner_element_06} alt="banner_element_06" className='absolute right-[60px] bottom-[280px] z-30 pointer-events-none select-none' />
                    <img src={banner_element_07} alt="banner_element_07" className='absolute left-[650px] bottom-0 z-30 pointer-events-none select-none' />
                    <img src={banner_img_bg_03} alt="banner_img_bg_03" className='absolute sm:right-[150px] sm:top-[50px] w-[350px] sm:w-[700px] bottom-5 pointer-events-none select-none' />
                    <img src={banner_img_03} alt="banner_img_bg_03" className='absolute sm:right-[100px] sm:top-[110px] bottom-5 pointer-events-none select-none' />
                    <Container>
                        <div className='flex'>
                            <div>
                                <div className='flex items-center gap-3 justify-center sm:justify-start mt-10'>
