...
import brandPartner_element01 from "../../assets/brandPartner/brandPartner_element01.png"
import brandPartner_element02 from "../../assets/brandPartner/brandPartner_element02.png"


function BrandPartners() {
    return (
        <div className='mt-[50px]  relative bg-button py-[200px]'>
            ...
            <img src={brandPartner_element02} alt="brandPartner_element02" className='absolute left-0 top-0 pointer-events-none select-none'/>
            <Container>
                <div className='grid grid-cols-12 gap-20'>
                    ...
                    <div className='col-span-4 capitalize z-999 select-none'>
            ...
            <img src={brandPartner_element01} alt="brandPartner_element01" className='absolute right-0 -bottom-5 pointer-events-none select-none'/>
