...
function ImgProduct() {
    return (
        <div className='bg-imgProduct_bg relative '>
            ...
            <img src={imgProduct_element_one} alt="imgProduct_element_one" className='absolute  w-[200px] md:w-[566px] pointer-events-none select-none' />
            <img src={imgProduct_element_two} alt="imgProduct_element_two" className='absolute bottom-90 md:bottom-0 left-50 md:left-140 w-[200px] md:w-[390px] pointer-events-none select-none' />

            <Container>
                <div className='md:flex md:flex-col max-w-[450px] pt-[120px] pb-[400px] md:py-[200px] mx-3 md:mx-0'>
                    <p className='font-subHeading text-red-btn text-[25px] md:text-[30px] capitalize mb-1 md:mb-5'>taste of the wild</p>
                    <p className='font-heading capitalize font-bold text-heading text-[40px] md:text-[65px] leading-11 md:leading-20 mb-3 md:mb-5'>pet food as it should be, pure & simple.</p>
                    ...
                    <div className='flex items-center bg-red-btn w-fit md:my-5 py-2 px-3 md:py-3 md:px-6 gap-3 rounded-[10px] cursor-pointer hover:bg-button duration-300'>
                        <p className='capitalize font-primary text-14px md:text-[18px] font-bold text-white'>shop now</p>
                        <BsArrowRightSquareFill className='text-white text-[18px] md:text-[22px] mt-0.5' />
                    </div>
                </div>
            </Container>

            <div className='absolute right-0 bottom-0 md:top-0 z-10'>
                <img src={imgProduct_bg} alt="imgProduct_bg" className='pointer-events-none select-none'/>
                
                <div className='absolute z-30 right-10 top-40 md:right-[610px] md:top-[510px] w-10 h-10 flex items-center justify-center group animate-bounce'>
                    ...
                    <div className='absolute -top-80 right-4 md:-right-20  scale-0 group-hover:scale-100 duration-300 origin-bottom-right md:origin-bottom'>
                        <div
                ...
                <div className='absolute z-30 right-25 top-70 md:right-[400px] md:top-[540px] w-10 h-10 flex items-center justify-center group animate-bounce'>
                    <span className="absolute inset-0 animate-ping rounded-full bg-white opacity-90"></span>
                    <span className="relative inline-flex   w-4 h-4 rounded-full bg-white group-hover:w-5 group-hover:h-5 duration-300 group-hover:bg-orange-btn"></span>
                ...
                <div className='absolute md:z-50 right-[245px] bottom-[120px] md:bottom-[150px] w-10 h-10 flex items-center justify-center group animate-bounce'>
                    <span className="absolute inset-0 animate-ping rounded-full bg-white opacity-90"></span>
                    <span className="relative inline-flex   w-4 h-4 rounded-full bg-white group-hover:w-5 group-hover:h-5 duration-300 group-hover:bg-orange-btn"></span>
                    <div className='absolute z-999 -top-80 -right-22  scale-0 group-hover:scale-100 duration-300 origin-bottom'>
                        <div
                            className='border border-gray-300 rounded-[20px] h-[325px] w-[216px] hover:h-[395px] transition-all duration-300 ease-in-out bg-white overflow-hidden relative'
                        >
                            <img
                ...
                <div className='absolute md:z-30 bottom-30 right-40 md:right-[140px] md:bottom-[430px] w-10 h-10 flex items-center justify-center group animate-bounce'>
                    <span className="absolute inset-0 animate-ping rounded-full bg-white opacity-90"></span>
                    <span className="relative inline-flex   w-4 h-4 rounded-full bg-white group-hover:w-5 group-hover:h-5 duration-300 group-hover:bg-orange-btn"></span>
                    <div className='absolute -top-80 -right-22  scale-0 group-hover:scale-100 duration-300 origin-bottom'>
                        <div
