...
function ImgProduct() {
    return (
        <div className='bg-imgProduct_bg relative '>
            ...
            <img src={imgProduct_element_one} alt="imgProduct_element_one" className='absolute pointer-events-none select-none' />
            <img src={imgProduct_element_two} alt="imgProduct_element_two" className='absolute bottom-0 left-140 pointer-events-none select-none' />
